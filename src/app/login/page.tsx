    ...
    <div className="flex min-h-screen items-center justify-center bg-background">
      <div className="mx-auto flex w-full max-w-sm flex-col items-center gap-8 px-4">
        ...
        >
          <button
            type="submit"
            className="flex h-12 items-center gap-3 rounded-xl border border-border bg-card px-6 text-sm font-medium shadow-sm transition-colors hover:bg-accent"
          >
        ...
        <p className="text-xs text-muted-foreground">
          Private app for you and friends
        </p>
      </div>
    </div>
  );
